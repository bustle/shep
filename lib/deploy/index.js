...
exports.default = function (api, _ref, flags) {
  ...
  // hack. use propmt
  if (!envName) {
    throw 'Specify an environment';
  }

  var funcs = _glob2.default.sync('functions/*/');
  var envConfig = require(_path2.default.join(process.cwd(), 'env.js'))[envName];
  var apiGateway = new _awsSdk2.default.APIGateway();
  var lambda = new _awsSdk2.default.Lambda();

  return _bluebird2.default.resolve(funcs).tap(function () {
